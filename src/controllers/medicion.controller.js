...
//         // 📌 Tipos de imágenes a procesar
//         const imageTypes = ["foto_taxilitro", "foto_tanque"];

//         const queryBodegas = `SELECT id_bod, descripcion FROM bodega WHERE id_sucursal = @id_suc AND id_bod = @id_bod;`;
...
//         const bodegas = resultBodegas.recordset;
//         if (bodegas.length === 0) {
//             return res.status(404).json({ error: "No se encontraron bodegas para esta sucursal." });
//         }
...
//         // 📌 3. Obtener la medición inicial (tipo = 1)
//         const queryInicial = `
//                 SELECT mi.*, (SUBSTRING(CAST(mi.fecha AS varchar(8)), 7, 2) + '-' + 
...
//                 picos: resultPicosInicial.recordset.length > 0 ? resultPicosInicial.recordset : [],
//                 picos2: resultPicosInicial.recordset.length > 0 ? resultPicosInicial.recordset[1] : [],
//                 tanques: resultTanquesInicial.recordset.length > 0 ? resultTanquesInicial.recordset : []
//             };
//             //console.log(resultMedicionInicial.picos);
//             //console.log(resultMedicionInicial.tanques);

//             // resultPicosInicial.recordset.forEach((p) => {
//             //     console.log(`📌 PICO: ${p.pico}, ID Pico: ${p.id_pico}, RowNumber: ${p.RowNumber}`);
//             // });

//             // console.log("resultMedicionInicial:---", resultMedicionInicial.picos);

//             // 📌 Convertir imágenes a base64
//             //const decodedImagesInicial = await readAndConvertImages(folderPath, imageTypes, [resultMedicionInicial.picos[0]]);

//             const decodedImagesInicial = await readAndConvertImages(folderPath, imageTypes, resultMedicionInicial.picos);
//             const decodedImagesInicial3 = await readAndConvertImages(folderPath, imageTypes, resultMedicionInicial.picos2);
//             //console.log(decodedImagesInicial);

//             const decodedImagesInicial2 = await readAndConvertImages(folderPath, imageTypes, resultMedicionInicial.tanques);


//             //console.log("decodedImagesInicial:---", decodedImagesInicial);
//             //console.log(decodedImagesInicial);

//             // 📌 Formatear medición inicial con base64
...
//                         litros: t.litros,
//                         foto_tanque: decodedImagesInicial2.foto_tanque || []
//                     };
//                     return acc;
//                 }, {}),


//                 picos: resultPicosInicial.recordset.reduce((acc, p, index) => {
//                     acc[p.pico] = {
//                         taxilitro: p.taxilitro,
//                         foto_taxilitro: decodedImagesInicial.foto_taxilitro[index] ?? [] // 📌 Asigna imagen por índice
//                     };
//                     return acc;
//                 }, {}),
//                 foto_taxilitro_pico_2: decodedImagesInicial3.foto_taxilitro || []

//             };
//         }

//         // 📌 4. Obtener la medición final (tipo = 2)
//         const queryFinal = `
...
//                 ...resultPicosFinal.recordset.length > 0 ? resultPicosFinal.recordset[0] : {},
//                 ...resultTanquesFinal.recordset.length > 0 ? resultTanquesFinal.recordset[0] : {}
//             }

//             // 📌 Convertir imágenes a base64
//             const decodedImagesFinal = await readAndConvertImages(folderPath, imageTypes, [resultMedicionFinal]);

//             // 📌 Formatear medición final con base64
...
//                 },
//                 tanques: resultTanquesFinal.recordset.reduce((acc, t) => {
//                     acc[t.descripcion_tanque] = {
//                         regla: t.regla,
//                         temperatura: t.temperatura,
//                         litros: t.litros,
//                         foto_tanque: decodedImagesFinal.foto_tanque || []
//                     };
//                     return acc;
//                 }, {}),
//                 picos: resultPicosFinal.recordset.reduce((acc, p) => {
//                     acc[p.pico] = {
//                         taxilitro: p.taxilitro,
//                         foto_taxilitro: decodedImagesFinal.foto_taxilitro || []
//                     };
//                     return acc;
//                 }, {})
//             };
